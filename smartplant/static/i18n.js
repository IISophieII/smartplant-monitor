...
translations.push([' trend', '趋势'],
 ['Alarm history','告警记录'], ['One record per abnormal episode. Acknowledging does not clear an active fault.','每段异常生成一条记录；确认告警不会解除故障。'],
 ['Acknowledgement','确认状态'], ['Acknowledged','已确认'], ['Acknowledge','确认告警'],
 ['No alarms recorded','暂无告警'], ['Started','开始时间'], ['Recovered','恢复时间'],
 ['Severity','最高级别'], ['Reasons','触发原因'], ['Active','持续中']);
